...
const GEMINI_API_KEY = process.env.GEMINI_API_KEY || 'AIzaSyCq9WGR5US0iZPoqHIGpY57AiA499cskSQ
';
const CONTACT_EMAIL = process.env.CONTACT_EMAIL || 'kslacelula.admi2@gmail.com';
