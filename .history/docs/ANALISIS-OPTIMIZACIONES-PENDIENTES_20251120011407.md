...
# Imágenes Responsivas (NUEVO)
bash scripts/optimize-images-responsive.sh [input] [output] [sizes]
...
**Comenzar con los iconos y logo:**

```bash
# 1. Convertir iconos a WebP
cd assets/icons
for file in *.png; do
...
**Generado automáticamente por análisis del proyecto**
