/*! YouTube Carousel Dynamic Loader with Lite Embeds */class YouTubeCarousel{constructor(){this.videos=[];this.settings={};this.currentGroupIndex=0;
    ...
    setupCarousel() {
        ...
        const existingGroups = this.container.querySelectorAll('.carousel-youtube-group');
        existingGroups.forEach(group => group.remove());

        // Generar grupos de videos
        this.generateVideoGroups();

        // Configurar botones de navegación (ahora están fuera del container)
        const section = this.container.closest('.carousel-youtube');
        this.prevBtn = section ? section.querySelector('.carousel-btn-prev') : document.querySelector('.carousel-btn-prev');
        this.nextBtn = section ? section.querySelector('.carousel-btn-next') : document.querySelector('.carousel-btn-next');
    ...
    generateVideoGroups() {
        ...
        for (let groupIndex = 0; groupIndex < totalGroups; groupIndex++) {
            ...
            groupDiv.className = 'carousel-youtube-group';
    ...
    createLiteEmbed(video) {
        ...
        videoDiv.className = 'carousel-youtube-video lite-youtube';
    ...
    showGroup(groupIndex) {
        const groups = this.container.querySelectorAll('.carousel-youtube-group');
    ...
    unloadGroupIframes(group) {
        const videos = group.querySelectorAll('.carousel-youtube-video');
    ...
    nextGroup() {
        const totalGroups = this.container.querySelectorAll('.carousel-youtube-group').length;
    ...
    getInfo() {
        return {
            ...
            totalGroups: this.container ? this.container.querySelectorAll('.carousel-youtube-group').length : 0,
