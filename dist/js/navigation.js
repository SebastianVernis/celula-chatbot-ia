/*! Grupo Musical Célula - Clean Navigation System */document.addEventListener('DOMContentLoaded', function () {
    console.log('🎵 Inicializando sistema de navegación limpio...'); function initSmoothScrolling() {
        const navLinks = document.querySelectorAll('.nav-link[href^="#"]'); navLinks.forEach(link => {
        ...
        video.addEventListener('error', function (e) {
            ...
            if (videoContainer) {
                videoContainer.style.background = `
                    ...
                    url('assets/gallery/hero-.background.webp') center/cover no-repeat
                `;
