/*! Grupo Musical Célula - Persistent Video Background Module */class PersistentVideoBackground {
    constructor(options = {}) {
        this.options = {
            videoBaseName: options.videoBaseName || 'assets/video/background', fallbackImage: options.fallbackImage || 'assets/gallery/hero-.background.webp', selector: options.selector || '.persistent-video-bg',
    ...
    getBackgroundImage() {
        ...
        if (deviceType === 'mobile' && orientation === 'portrait') {
            return this.normalizePath('assets/gallery/mobile-.background.webp');
        }

        // Usar la misma lógica que las media queries del CSS
        if (width <= 480) {
            return this.normalizePath('assets/gallery/hero-background-480w.webp');
        } else if (width <= 768) {
            return this.normalizePath('assets/gallery/hero-background-768w.webp');
        } else if (width <= 1024) {
            return this.normalizePath('assets/gallery/hero-background-1024w.webp');
        } else {
            return this.normalizePath('assets/gallery/hero-background-1920w.webp');
        }
    }
    ...
    addStyles() {
        ...
        style.textContent = `
            ...
            @media (max-width: 480px) {
                .persistent-video-container {
                    background-image: url('${this.normalizePath('assets/gallery/hero-background-480w.webp')}');
                }
            }
            
            @media (min-width: 481px) and (max-width: 768px) {
                .persistent-video-container {
                    background-image: url('${this.normalizePath('assets/gallery/hero-background-768w.webp')}');
                }
            }
            
            @media (min-width: 769px) and (max-width: 1024px) {
                .persistent-video-container {
                    background-image: url('${this.normalizePath('assets/gallery/hero-background-1024w.webp')}');
                }
            }
            
            @media (min-width: 1025px) {
                .persistent-video-container {
                    background-image: url('${this.normalizePath('assets/gallery/hero-background-1920w.webp')}');
                }
            }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const videoBgConfig = {
        ...
        fallbackImage: 'assets/gallery/hero-.background.webp',
